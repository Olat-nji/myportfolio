	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				...
				<span class="position"><a href="#">Fullstack Developer </a> </span>
			</div>
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<div class="desc">
						   					<h1>Solving Problems<br> is my Ninja Way!</h1>
				...
				<div class="colorlib-narrow-content">
					...
					<div class="row">
						<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
							<p>I am a fast -learning fullstack engineer. I've used technologies like PHP(laravel), Html, Javascript, Css, MySQL, Gihub,  AWS.</p>
						</div>
					...
					<div class="row">
						<div class="col-md-5">
							...
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="tel://">+234 8156851321</a></p>
								</div>
							</div>
						</div>
