...
<html>
	...
	<title>Olatunji David Olayemi</title>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				...
				<h1 id="colorlib-logo"><a href="index.html">Olatunji Olayemi</a></h1>
				<span class="position"><a href="#">Backend Developer Guy</a> in Nigeria</span>
			</div>
					   				...
					   				<div class="slider-text-inner">
					   					<div class="desc">
						   					<h1>I love<br>solving problems</h1>
												<h2>Check out my github <a href="https://githib.com/olat-nji" target="_blank">@olat-nji</a></h2>
						...
						<div class="col-md-12">
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
										...
										<p><strong>Hi I'm Olatunji Olayemi</strong> I'm a christian to the core , a yoruba guy from Oyo State(though i don't speak much yoruba). I'm fluent in the native dialect of <code>pidgin</code> english , haha .
                                          I love people , working with them, helping people,  Solving problems is my thing.</p>
										<p>Haha, I just cannot see a problem with having the urge to solve it. I hate procrastination. </p>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
									<div class="hire">
										<h2>I am happy to say <br>that i've done 300+ projects sucessfully!</h2>
						...
						<div class="col-md-4 text-center animate-box">
							<div class="services color-1">
								...
								<div class="desc">
									...
									<p>I could provide innovative ideas improve your business in this digital age </p>
								</div>
							</div>
						</div>
						<div class="col-md-4 text-center animate-box">
						...
						<div class="col-md-4 text-center animate-box">
							<div class="services color-4">
								...
								<div class="desc">
									...
									<p>Do you need to scale your website due to growing audience? i also do that!</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4 text-center animate-box">
							<div class="services color-6">
								...
								<div class="desc">
									...
									<p>I'm also a fullstack developer with 5 years experience in my field</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-5">
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="#">olayemi289@gmail.com</a></p>
								</div>
							</div>
							...
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="tel://">+234 9011048327</a></p>
								</div>
							</div>
						</div>
